                                ...
                                <div class="relative mt-2">
                                    <ListboxButton
                                        ...
                                        <span class="flex items-center">
                                            <img :src="getAvatar(kanban.users[kanban.taskProps.user_id || kanban.self.id])" 
                                                 alt="" 
...
const addOrEditCard = async (taskId) => {
    try {
        ...
        let taskRequest = {
            name: kanban.taskProps.name,
            phase_id: kanban.taskProps.phase_id,
            user_id: kanban.taskProps.user_id
        }
